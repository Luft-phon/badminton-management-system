        ...
        public static void Initialize(IServiceProvider service)    //IserviceProvider is used to resolve dependencies
        {
            ...
            if (!context.User.Any())
            {
                context.User.AddRange(
                   new User { UserID = 1, FirstName = "Alice", LastName = "Nguyen", Email = "alice@example.com", Role = Domain.Enum.Role.Staff, Dob = new DateTime(1995, 6, 15), Phone = "0123456789" },
                     new User { UserID = 2, FirstName = "Phong", LastName = "Ngo", Email = "bob@example.com", Role = Domain.Enum.Role.Owner, Dob = new DateTime(1990, 1, 20), Phone = "0987654321" },
                     new User { UserID = 3, FirstName = "Tuann", LastName = "NgoTran", Email = "bob@example.com", Role = Domain.Enum.Role.Member, Dob = new DateTime(1990, 1, 20), Phone = "0987654321" },
                     new User { UserID = 4, FirstName = "Thao", LastName = "Ngo", Email = "alice@example.com", Role = Domain.Enum.Role.Staff, Dob = new DateTime(1995, 6, 15), Phone = "0123456789" },
                     new User { UserID = 5, FirstName = "Huy", LastName = "Nguyen", Email = "bob@example.com", Role = Domain.Enum.Role.Owner, Dob = new DateTime(1990, 1, 20), Phone = "0987654321" },
                     new User { UserID = 6, FirstName = "Quan", LastName = "Ngo", Email = "bob@example.com", Role = Domain.Enum.Role.Member, Dob = new DateTime(1990, 1, 20), Phone = "0987654321" },
                     new User { UserID = 7, FirstName = "Nam", LastName = "Tran", Email = "nam1@example.com", Role = Domain.Enum.Role.Member, Dob = new DateTime(1992, 3, 1), Phone = "0912345671" },
                     new User { UserID = 8, FirstName = "Linh", LastName = "Le", Email = "linh2@example.com", Role = Domain.Enum.Role.Member, Dob = new DateTime(1994, 7, 12), Phone = "0912345672" },
                     new User { UserID = 9, FirstName = "Khoa", LastName = "Pham", Email = "khoa3@example.com", Role = Domain.Enum.Role.Member, Dob = new DateTime(1990, 11, 23), Phone = "0912345673" },
                     new User { UserID = 10, FirstName = "Mai", LastName = "Phuong", Email = "hello@gmail.com", Role = Domain.Enum.Role.Member, Dob = new DateTime(2025, 6, 30), Phone = "0912345674" },
                     new User { UserID = 11, FirstName = "Son", LastName = "Hoang", Email = "son5@example.com", Role = Domain.Enum.Role.Member, Dob = new DateTime(1993, 4, 5), Phone = "0912345675" },
                     new User { UserID = 12, FirstName = "Lan", LastName = "Doan", Email = "lan6@example.com", Role = Domain.Enum.Role.Member, Dob = new DateTime(1991, 8, 25), Phone = "0912345676" },
                     new User { UserID = 13, FirstName = "Duy", LastName = "Dang", Email = "duy7@example.com", Role = Domain.Enum.Role.Member, Dob = new DateTime(1995, 2, 10), Phone = "0912345677" },
                     new User { UserID = 14, FirstName = "Ha", LastName = "Nguyen", Email = "ha8@example.com", Role = Domain.Enum.Role.Member, Dob = new DateTime(1989, 12, 30), Phone = "0912345678" },
                     new User { UserID = 15, FirstName = "Trang", LastName = "Phan", Email = "trang9@example.com", Role = Domain.Enum.Role.Member, Dob = new DateTime(1997, 1, 9), Phone = "0912345679" },
                     new User { UserID = 16, FirstName = "Minh", LastName = "Vo", Email = "minh10@example.com", Role = Domain.Enum.Role.Member, Dob = new DateTime(1998, 5, 14), Phone = "0912345680" }
                );
                context.SaveChanges();
            }
